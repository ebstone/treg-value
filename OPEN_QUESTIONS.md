...
| C12 | US market shares across advanced therapies in moderate-to-severe CD (was O13) | Moot. S9 retired (SPEC_AMENDMENTS.md 2026-08-28); no current-treatment-mix comparator is built, so no market-share vector is needed. The single-comparator limitation is stated in SPEC.md L13 and the readout — Stone | 2026-08-28 |
